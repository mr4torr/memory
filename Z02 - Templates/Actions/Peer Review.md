...
const folder = `A06 - Peer Review/${currentMonth}`;

// 2. PROMPT E EXTRAÇÃO
let rawInput = await tp.system.prompt("Tarefa (Ex: FRPHP-1234 - Titulo da tarefa @01/12/2026 !High #api)", "");
...
task: "<% taskNumber %>"
category: "<% tp.system.suggester(["code-review", "cross-testing", "merge-request", "documentation"], ["code-review", "cross-testing", "merge-request", "documentation"], true, "Escolha a categoria...") %>"
involved:
  - "My"
tags:
<% tagsYaml %>
