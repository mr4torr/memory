...
The manifest lives at `$OBSIDIAN_WIKI_PATH/Wiki/.manifest.json`. It tracks every source file that has been ingested. If it doesn't exist, this is a fresh vault with nothing ingested.
...
```json
{
  ...
  "sources": {
    "/absolute/path/to/file.md": {
      ...
      "project": null,
      "pages_created": ["<OBSIDIAN_WIKI_PATH>/Wiki/concepts/transformers.md"],
      "pages_updated": ["<OBSIDIAN_WIKI_PATH>/Wiki/entities/vaswani.md"]
    },
    "<OBSIDIAN_WIKI_PATH>/Wiki/projects/-Users-name-my-app/abc123.jsonl": {
      "ingested_at": "2026-04-06T11:00:00Z",
      "size_bytes": 128000,
      "modified_at": "2026-04-06T09:00:00Z",
      "source_type": "agent_conversation",
      "project": "my-app",
      "pages_created": ["<OBSIDIAN_WIKI_PATH>/Wiki/entities/my-app.md"],
      "pages_updated": ["<OBSIDIAN_WIKI_PATH>/Wiki/skills/react-debugging.md"]
    }
  },
  "projects": {
    "my-app": {
      "source_path": "<OBSIDIAN_WIKI_PATH>/Wiki/projects/-Users-name-my-app",
      "vault_path": "<OBSIDIAN_WIKI_PATH>/Wiki/projects/my-app",
...
For OpenCode history specifically, also compute:
- New projects (directories in `$OBSIDIAN_WIKI_PATH/Wiki/projects/` not in manifest)
- New conversations within existing projects
- Updated memory files

For Kiro history specifically, also compute:
...
| ~/.opencode/Z01 - AI Obsidian/Wiki/projects/-Users-.../session-xyz.jsonl | agent_conversation | 340 KB |
| ~/.kiro/sessions/2026/04/12/rollout-...jsonl | kiro_rollout | 220 KB |
| ... | | |
...
- `category[page]` = directory prefix (Z01 - AI Obsidian/Wiki/concepts/, Z01 - AI Obsidian/Wiki/entities/, Z01 - AI Obsidian/Wiki/skills/, etc.)
...
4. **Surprising connections.** Cross-category wikilinks that are non-obvious — scored by how unexpected they are:
   - Score each wikilink that crosses category boundaries (e.g., `Wiki/concepts/` → `Wiki/entities/`, `Wiki/skills/` → `Wiki/synthesis/`):
...
|---|---|---|---|
| [[Wiki/concepts/transformer-architecture]] | 23 | 8 | connector hub |
| [[Wiki/entities/andrej-karpathy]] | 17 | 0 | sink hub — cross-linker candidate |

## Bridge Pages (top 5)
| Page | Bridges | Cross-cluster pairs |
|---|---|---|
| [[Wiki/concepts/exponential-growth]] | #ml ↔ #economics | 4 pairs |
...
- [[Wiki/concepts/scaling-laws]] → [[Wiki/entities/gordon-moore]] — score 5
  - Reason: cross-layer (concepts ↔ entities), marked ^[inferred]
- ...

## Orphan-Adjacent (dead-ends near hubs)
- [[Wiki/concepts/foo]] — linked from 3 hubs, 0 outbound links
...
- Newly connected: [[Wiki/concepts/bar]], [[Wiki/entities/baz]]
- Lost incoming links: [[Wiki/references/old-paper]] (target may have been renamed)
...
3. Link: `Wiki/references/foo.md` has no incoming links — what should reference it?
4. Audit: Should tag `#systems` be split? (cohesion 0.06, 7 pages)

<!-- GRAPH_SNAPSHOT: {"nodes":["Wiki/concepts/foo","Wiki/entities/bar"],"edges":[["Wiki/concepts/foo","Wiki/entities/bar"]]} -->
```
...
- The actual ingest work is done by the ingest skills (`wiki-ingest`, `data-ingest`)
